...
func (h *Handler) createGame(w http.ResponseWriter, r *http.Request) {
	...
	game, err := h.gameSvc.CreateGame(r.Context(), req.ChatID, req.GameDate, req.Courts, req.VenueID)
	if err != nil {
...
func (h *Handler) listGames(w http.ResponseWriter, r *http.Request) {
	...
	if rawIDs != "" {
		...
		games, err := h.gameSvc.GetUpcomingGamesByChatIDs(ctx, chatIDs)
		if err != nil {
	...
	games, err := h.gameSvc.GetUpcomingGames(ctx)
	if err != nil {
...
func (h *Handler) getGame(w http.ResponseWriter, r *http.Request) {
	...
	game, err := h.gameSvc.GetByID(r.Context(), id)
	if err != nil {
...
func (h *Handler) updateMessageID(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.gameSvc.UpdateMessageID(r.Context(), id, req.MessageID); err != nil {
...
func (h *Handler) updateCourts(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.gameSvc.UpdateCourts(r.Context(), id, req.Courts); err != nil {
...
func (h *Handler) getNextGame(w http.ResponseWriter, r *http.Request) {
	...
	game, err := h.playerSvc.GetNextGame(r.Context(), telegramID)
	if err != nil {
...
func (h *Handler) listPlayerGames(w http.ResponseWriter, r *http.Request) {
	...
	games, err := h.playerSvc.ListGames(r.Context(), playerID)
	if err != nil {
