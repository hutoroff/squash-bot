...
type AdminGroupsResolver struct {
	...
	tgAPI     outbound.TelegramAPI
	logger    *slog.Logger
}

func NewAdminGroupsResolver(groupRepo outbound.GroupRepository, tgAPI outbound.TelegramAPI, logger *slog.Logger) *AdminGroupsResolver {
