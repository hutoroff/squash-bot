...
func (b *Bot) buildCallbackRouter() map[string]callbackHandler {
	...
	return map[string]callbackHandler{
		...
		"manage_courts_mode":           b.handleManageCourtsMode,
		"manage_book":                  b.handleManageBook,
		"manage_book_cancel":           int64H(b.handleManageBookCancel),
		...
		"leaderboard_cfg":           int64H(b.handleLeaderboardConfig),
		"toggle_leaderboard_notify": int64H(b.handleToggleLeaderboardNotify),
