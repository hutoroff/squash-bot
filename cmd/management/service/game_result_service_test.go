...
func (r *stubGameRepoForResults) GetUpcomingGamesForHalfwayCheck(_ context.Context) ([]*models.Game, error) {
	return nil, nil
}
func (r *stubGameRepoForResults) MarkHalfwayCourtCheckDone(_ context.Context, _ int64) error {
	return nil
}
